...
describe('DanceGroupsAdmin', () => {
  beforeEach(() => {
    ...
    vi.mocked(createDanceGroup).mockResolvedValue({ id: 3, name: 'New Group', created_at: '2024-01-01' });
    vi.mocked(updateDanceGroup).mockResolvedValue({ id: 1, name: 'Renamed Group', created_at: '2024-01-01' });
